...
Light light(glm::vec3{1.2f, 1.0f, 2.0f}, glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3(0.2f, 0.2f, 0.2f), glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3(0.5f, 0.5f, 0.5f));
...
int main(int argc, char **argv)
{
    ...
    bool emissionMove = true;
    bool emissionFlick = true;
