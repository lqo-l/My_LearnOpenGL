...
int main(int argc, char** argv)
{
	...
	/// 着色器
	Shader objectShader(getAssetAbsPath(argv[0],"phong_world.vert"), getAssetAbsPath(argv[0],"object_phong_world.frag")); // 物体着色器
	Shader lightShader(getAssetAbsPath(argv[0],"phong_world.vert"), getAssetAbsPath(argv[0],"light.frag")); // 光源着色器。vert仅用于计算MVP变换，frag仅展示一个白色光源立方体
