...
int main(int argc, char **argv)
{
    ...
    std::string flashTexPath = getAssetAbsPath(argv[0], "assets/02_lighting/textures/flashboom.png");


    unsigned int diffuseMap, specularMap, emissionMap, flashTexture;
    ...
    flashTexture = loadTexture(flashTexPath.c_str(), GL_CLAMP_TO_BORDER, GL_CLAMP_TO_BORDER); // 超出坐标指定为黑色（透明）
    ...
    objShader.setInt("flashTexture", 3);
